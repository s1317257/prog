...
if (isset($_FILES["upfile"] ) && $_FILES["upfile"]["error"] ==0 ) {
   ...
   $extenstion = pathinfo($file_name, PATHINFO_EXTENSION);//拡張子を取得$extenstion=(jpg,png,gif)
   $uniq_name = date("YmdHis").md5(session_id()) . "." . $extenstion;//md5でハッシュ化している
...
<body>
    ...
    <?php
    echo date("Ymd-H:i:s",filemtime($uniq_name));
    ?>
