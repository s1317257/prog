<?php
 ...
 foreach($files as $file){
     if($file->isFile() ){
         $list .= '<img src="'.$file->getPathname() . '"><br>';//.=はどんどん追加するという意味
         $list .= ''.$file->getPathname() . '<br>';
     }
 }
...
<style>
#photarea{padding:5%;width:100%;background:#99CCFF;}
img{height:200px;}
</style>
...
<!-- IMG_LIST[Start] -->
 ...
 <p><input id="img_width_range" type="range" step="10" max="400" min="50" value="200"></p>
  <div class="jumbotron"><span id="heigth_txt">200px</span>
    ...
    <div id="photarea"><?=$filese?></div>
    <?php
    echo date("Ymd-H:i:s",filemtime($file));
    ?>
  </div>
</div>
<!-- IMG_LIST[END] -->
